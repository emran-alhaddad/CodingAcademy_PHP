    ...
    <div class="container-fluid" style="padding-left: 3rem; padding-right:3rem">
        ...
        <div class="d-flex flex-column flex-md-row align-items-center py-2">
            <a href="index.php" class="my-0 mr-md-auto" style="width: 6rem;">
                <img src="Assets/img/logo/logo.png" alt="dev culture logo" style="width: 80%;height: auto;">
            </a>
            ...
            <a class="btn btn-outline-success" href="<?= (isset($GLOBALS['loggedin'])) ? 'Logout.php' : 'login.php'; ?>">
                <?= (isset($GLOBALS['loggedin'])) ? 'Logout' : 'Sign in'; ?>
            </a>
